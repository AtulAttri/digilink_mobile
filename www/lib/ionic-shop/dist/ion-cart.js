  ...
  app.service('Products',['$http',function($http){
    ...
    this.addToCart = function(product){
      ...
      if (productInCart) {
        ...
        //  $scope.cartProducts_qty=0;
       //   $scope.cartProducts_qty= this.cartProducts.length;
      }
      }
...
(function(angular) {
    ...
    var link = function(scope, element, attr) {
     ...
     scope.emptyProducts = scope.products.length ? false : true;
      ...
      scope.removeProduct = function(product){
          ...
          scope.qty=Products.cartProducts.length;

          scope.$watch(function(scope) { return scope.qty },
              function(newValue, oldValue) {
                  scope.$root.cartProducts_qty=newValue;
              }
          );
  ...
  app.directive('ionGallery', ['Products', '$templateCache', function(Products, $templateCache,$scope){
    var link = function(scope, element, attr) {

      scope.addToCart = function(product){
        Products.addToCart(product,$scope);
